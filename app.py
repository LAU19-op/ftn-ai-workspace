...
# --- 7. PLATAFORMA CENTRAL ---
    ...
    # ==========================================
        ...
        for op, ic in zip(opciones_nav, iconos_nav):
            # Roles pueden ver todo si son Super Admin
        ...
        with col_content:
            # --- LÓGICA DE LOS 25 MÓDULOS INTACTA ---
